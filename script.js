class Game {
  ...
  winMomen() {
    if (this.botChoice === "kertasbot" && this.playerChoice === "gunting-p1") {
      ...
      this.botChoice === "kertasbot" &&
      this.playerChoice === "batu-p1"
    ) {
      return `Yah, ${this.botName} Menang!`;
    } else if (
      this.botChoice === "guntingbot" &&
      this.playerChoice === "kertas-p1"
    ) {
      return `Yah, ${this.botName} Menang!`;
    } else if (
      this.botChoice === "guntingbot" &&
      ...
      this.botChoice === "batubot" &&
      this.playerChoice === "kertas-p1"
    ) {
      return `Hore ${this.playerName} Menang!`;
    } else if (
      this.botChoice === "batubot" &&
      this.playerChoice === "gunting-p1"
    ) {
      return `Yah, ${this.botName} Menang!`;
    } else {
